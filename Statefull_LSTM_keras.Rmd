...
This post is a duplicate of the post contributed to R-bloggers from business-science over at:  
http://www.business-science.io/timeseries-analysis/2018/04/18/keras-lstm-sunspots-time-series-prediction.html

I loved the post so much that I decided to run it and keep the script up for reference to my future work  
